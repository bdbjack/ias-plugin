			...
			<table class="widefat" role="table" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<tr>
						...
						<td><input type="url" name="URL" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('Login by Credentials URL', IAS_TEXTDOMAIN); ?></th>
						<td><input type="url" name="loginByCredsURL" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('URL of Logo', IAS_TEXTDOMAIN); ?></th>
						<td><input type="url" name="logoURL" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('Campaign ID', IAS_TEXTDOMAIN); ?></th>
						<td><input type="number" min="0" name="campaignID" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('API URL', IAS_TEXTDOMAIN); ?></th>
						<td><input type="url" name="apiURL" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('API User', IAS_TEXTDOMAIN); ?></th>
						<td><input type="text" name="apiUser" style="width:100%;" required /></td>
					</tr>
					<tr>
						<th><?php _e('API Password', IAS_TEXTDOMAIN); ?></th>
						<td><input type="password" name="apiPass" style="width:100%;" required /></td>
					</tr>
					<tr>
