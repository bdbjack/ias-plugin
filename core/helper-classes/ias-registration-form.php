 ...
 class ias_registration_form extends ias_forms {
	...
	public static function action() {
		...
		$spot_reg_customer_array = array(
			...
			'subCampaign' => ( !is_null( $_POST['tracker'] ) ) ? $_POST['tracker'] : '',
			'a_aid' => ( !is_null( $_POST['a_aid'] ) ) ? $_POST['a_aid'] : '',
			'a_bid' => ( !is_null( $_POST['a_bid'] ) ) ? $_POST['a_bid'] : '',
			'a_cid' => ( !is_null( $_POST['a_cid'] ) ) ? $_POST['a_cid'] : '',
